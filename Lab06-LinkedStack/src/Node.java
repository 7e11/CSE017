...
public class Node<E>
{
    ...
    {
        if (next != null) {
            throw new IllegalStateException("this.next is not null");
        }
        if (newNext == null) {
            //nothings happens, avoid null pointer
            //already checked next is null
            return this;
        }
        if (newNext.previous() != null) {
            throw new IllegalStateException("newNext.previous is not null");
        }
        next = newNext;
        newNext.previous = this;
        //even though previous is private, they are the same class
        return this;
    }
